    ...
    render() {
        return (
            <div>
                ...
                <h1 className="subtitleStyle">SETUP:</h1>
                ...
                <h1 className="subtitleStyle">BIDDING:</h1>
                <ul className="textStyle">
                ...
                <h1 className="subtitleStyle">THE PLAY:</h1>
                <ul className="textStyle">
                ...
                <h1 className="subtitleStyle">HOW TO WIN A HAND:</h1>
                <ul className="texttyle">
                ...
                <h1 className="subtitleStyle">HOW TO WIN:</h1>
                <ul className="textStyle">
                ...
                <h1 className="subtitleStyle">POINT BREAKDOWN: (120 total)</h1>
                <ul className="textStyle">
