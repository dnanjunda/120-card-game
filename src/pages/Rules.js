...
import styles from '../css/Rules.css';
...
class Rules extends React.Component {
    render() {
        ...
        return (
            <div>
                <h1 style={styles.titleStyle}>How To Play:</h1>
                <h1 style={styles.subtitleStyle}>SETUP:</h1>
                ...
                <h1 style={styles.subtitleStyle}>BIDDING:</h1>
                <ul style={styles.textStyle}>
                ...
                <h1 style={styles.subtitleStyle}>THE PLAY:</h1>
                <ul style={styles.textStyle}>
                ...
                <h1 style={styles.subtitleStyle}>HOW TO WIN A HAND:</h1>
                <ul style={styles.textStyle}>
                ...
                <h1 style={styles.subtitleStyle}>HOW TO WIN:</h1>
                <ul style={styles.textStyle}>
                ...
                <h1 style={styles.subtitleStyle}>POINT BREAKDOWN: (120 total)</h1>
                <ul style={styles.textStyle}>
